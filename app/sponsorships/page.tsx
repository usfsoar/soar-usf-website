        ...
        <div className="container mx-auto max-w-6xl mt-20 px-4 md:px-6">
          ...
          <div className="flex flex-col gap-6 md:gap-8">
            ...
            <div className="space-y-3">
              ...
              <a href="https://drive.google.com/file/d/1uo0gVncEJsBDRaWBNZDJ9E5HZCcrThbo/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="w-full bg-zinc-900 hover:bg-zinc-800 text-white rounded-lg py-3 md:py-4 px-4 md:px-6 flex items-center justify-center gap-2 transition-colors group cursor-pointer text-sm md:text-base">
