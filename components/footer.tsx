      ...
      <div className="container mx-auto max-w-7xl">
        <div className="mb-16">
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            <div className="bg-[#5865F2] rounded-lg p-4 w-full lg:w-72 flex-shrink-0">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-xs text-white/60">1.5k Online</span>
              </div>
              ...
              <div className="border-t border-white/10 pt-3">
                <div className="text-xs text-white/60 mb-2">MEMBERS ONLINE</div>
                <div className="space-y-1.5 text-xs">
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-green-500" />
                    <span className="text-white/80">Aaron P</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-green-500" />
                    <span className="text-white/80">Alison B</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-green-500" />
                    <span className="text-white/80">Allen C</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-yellow-500" />
                    <span className="text-white/80">Mathew</span>
                  </div>
                </div>
              </div>
